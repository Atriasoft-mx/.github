...
graph LR
    ...
    subgraph Backend & APIs
        E[Java / Spring Boot] 
        F[Python / FastAPI / Django]
        G[Laravel / PHP] 
        H[JavaScript / Node]
    end
    subgraph Datos & Cloud
        I[(PostgreSQL / Oracle / MySQL)]
        J[Pandas & ETL Pipelines]
        K[Docker & Cloud Deployment]
    end
...
<div align="center">
  ...
  <sub>© 2026 **Atria.Software** • Consultoría y Desarrollo Tecnológico Integral.</sub>
